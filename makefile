...
build/kernel.bin:build/init.o build/interrupt.o build/kernel.o build/main.o build/print.o build/timer.o
	ld -m elf_i386 -Ttext 0xc0001500 -e main -o build/kernel.bin build/init.o  build/interrupt.o \
		build/kernel.o  build/main.o  build/print.o build/timer.o
